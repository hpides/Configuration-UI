    ...
    public renderStoryListItem(story: string): JSX.Element {
        ...
        if (story === this.state.activeStory) {
            ...
            content = <input
                ...
                onBlur={this.props.currentView === Views.UserStories ? this.props._keyhandler.enableDeleteKey : () => {}}
                onFocus={this.props.currentView === Views.UserStories ? this.props._keyhandler.disableDeleteKey: () => {}}
                ref={(reference) => {
                    if (reference) {
                        reference.focus();
                    }
